...
class FlightTicket {
    ...
    // Constructor
    public FlightTicket(String passengerName, String flightNumber, 
    		String source, String destination, String departureDate, double ticketPrice) {
...
public class Main21 {
    public static void main(String[] args) {
        ...
        FlightTicket ticket = new FlightTicket("Aarav", "AI202", "Delhi", "Mumbai", 
        		"15-12-2022", 5000.0);
